...
const StudentInfo = () => {
  ...
  return (
    <div className="Noticepage" onClick={handleOutsideClick}>
       <div id="teachnav">
    <Teachnav/>
    </div>
          ...
          <div className="card3">
            <div className="box add-notice">
              <div className="content">
                ...
                <a onClick={() => navigate('/Teacherprofile/Noticepage/Addnotice')}>Add Notice</a>
              </div>
            </div>
          </div>
          ...
          <div className="card3">
            <div className="box list-notice">
              <div className="content">
                ...
                <a onClick={() => navigate('/Teacherprofile/Noticepage/Listnotice')}>View List</a>
              </div>
            </div>
          </div>
        </div>
